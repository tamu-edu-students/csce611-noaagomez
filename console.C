/* 
    ...
    Revised: 8/8/2024: Added redirection using serial (0x3F8) to stdout in console.
...
/* -- GLOBAL VARIABLES -- */
 ...
 bool Console::output_redirected = false;
...
void Console::redirect_output(bool _on_off) {
    output_redirected = _on_off;
}
